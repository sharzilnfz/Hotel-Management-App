  ...
  useEffect(() => {
    ...
    const fetchMetadata = async () => {
      try {
        ...
        toast.error(
          'Failed to load some form options. Some fields may be limited.'
        );
      }
    };
    ...
    const fetchStaffData = async () => {
      ...
      try {
        ...
        if (axios.isAxiosError(err)) {
          ...
          const errorMessage =
            responseData?.message || err.message || 'Failed to load staff data';
  ...
  const onSubmit = async (data: FormValues) => {
    try {
      ...
      try {
        ...
        console.log(
          'Updated staff data:',
          response.data.data?.staff || response.data.data
        );
