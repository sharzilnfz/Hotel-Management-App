...
const MeetingHall = () => {
    ...
    const {  loading, error,  meetingContent, fetchMeetingContent } = useContext(ContentContext)
    ...
    const fetchMeetingHalls = async () => {
        ...
        setHallsError(null)
        try {
            const response = await fetch('http://localhost:4000/api/meeting-hall/halls')
            const data = await response.json()
            if (data.status === 'success') {
                // Filter only available halls
                const availableHalls = data.data.halls.filter(hall => 
    ...
    return (
        <>
            ...
            <div className="content-section parallax-section hero-section hidden-section">
                <div className="bg par-elem" data-bg={meetingContent?.coverImage ? `http://localhost:4000${meetingContent.coverImage}` : `http://localhost:4000/uploads/content/image-1748947475438-981074244.jpeg`}></div>
                <div className="overlay"></div>
                <div className="container">
                    <div className="section-title">
                        <h4>{meetingContent?.description || "Professional spaces for your business needs"}</h4>
                        <h2>{meetingContent?.title || "Meeting Halls & Conference Rooms"}</h2>
            ...
            <div className="content">
                ...
                <div className="breadcrumbs-wrap">
                    <div className="container">
                        <Link to="/">Home</Link><span>Meeting Halls</span>
                    </div>
                </div>
                {/* Breadcrumbs end */}
                ...
                <div className="content-section">
                    ...
                    <div className="container small-container">
                        <div className="section-title">
                            ...
                            <div className="section-separator"><span><i className="fa-thin fa-gem"></i></span></div>
                            <p>Host your business meetings, conferences, and corporate events in our elegant and well-equipped meeting halls. Each space is designed to inspire productivity and collaboration.</p>
                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-3">
                                            <div className="quantity">
                                                ...
                                                <div className="quantity-item">
                                                    ...
                                                    <input type="text" name="quantity" title="Qty" className="qty color-bg" data-min="1" data-max="12" data-step="1" value="2" />
                                        ...
                                        <div className="col-lg-3">
                                            <div className="quantity">
                                                ...
                                                <div className="quantity-item">
                                                    <input type="button" value="-" className="minus" />
                                                    <input type="text" name="quantity" title="Qty" className="qty color-bg" data-min="5" data-max="100" data-step="5" value="20" />
                                                    <input type="button" value="+" className="plus" />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg-2">
                                            <button className="searchform-submit" id="searchform-submit">Book Hall</button>
                                        </div>
                                    </div>
                                </fieldset>
                            </form>
                    ...
                    <div className="container">
                                            ...
                                            <div className="hall-card" key={hall._id}>
                                                <div className="hall-card-header">
                                                    <div className="hall-badge">
                                                        <span className={`status-badge ${hall.status.toLowerCase()}`}>
                                                            {hall.status}
                                                        </span>
                                                    </div>
                                                ...
                                                <div className="hall-card-content">
                                                    <h3 className="hall-title">
                                                        <Link to={`/meeting-hall/${hall._id}`}>{hall.name}</Link>
                                                    </h3>
                                                        ...
                                                        <div className="hall-amenities">
                                                            ...
                                                            <div className="amenities-list">
                                                                ...
                                                                {hall.amenities.length > 3 && (
                                                                    <span className="more-amenities">+{hall.amenities.length - 3} more</span>
                                                                )}
                                                            </div>
                                                        </div>
                                                    )}
                                                    ...
                                                    <div className="hall-card-footer">
                                                        ...
                                                        <div className="hall-actions">
                                                            ...
                                                            <Link to={`/meeting-hall/${hall._id}`} className="view-details-btn">
                                                                View Details
                        ...
                        {/* Pagination */}
                        {!hallsLoading && !hallsError && meetingHalls.length > 0 && totalPages > 1 && (
