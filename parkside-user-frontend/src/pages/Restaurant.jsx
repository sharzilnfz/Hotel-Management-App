...
import { restaurantInfo, restaurantServices } from '../data/restaurantData';
...
const Restaurant = () => {
  ...
  const fetchMenuItems = async () => {
    try {
      ...
      if (response.data.success) {
        ...
        const categoryWithItems = MENU_CATEGORIES.find(
          (cat) => groupedItems[cat.id] && groupedItems[cat.id].length > 0
        );
  ...
  // Load menu items and restaurant settings on mount
  useEffect(() => {
    fetchMenuItems();
  ...
  return (
    <>
      ...
      <div className="restaurant-page-wrapper">
        {/* Hero Section */}
        <div
          className="content-section parallax-section hero-section hidden-section"
            ...
            style={{
              backgroundImage: `url('${
                restaurantSettings?.coverImage
                  ? `http://localhost:4000${restaurantSettings.coverImage}`
                  : '/src/assets/images/restaurant/1.jpg'
              }')`,
            }}
        ...
        <div className="content">
            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-6">
                  <div
                    className="section-title text-align_left"
                  ...
                  <div className="text-block tb-sin">
                    ...
                    <p>
                      {(restaurantSettings?.headChef &&
                        restaurantSettings?.cuisineType) ||
                      (restaurantContent?.headChef &&
                        restaurantContent?.cuisineType)
                        ? `Our head chef, ${
                            restaurantSettings?.headChef ||
                            restaurantContent?.headChef
                          }, specializes in ${
                    ...
                    <a
                      href="#secmenu"
                      className="btn fl-btn custom-scroll-link"
                    >
                      Explore Our Menu
                    </a>
                  </div>
                  ...
                  <div className="image-collge-wrap">
                    <div className="blog-media">
                      <div className="single-slider-wrap">
                        <div className="single-slider">
                          <div className="swiper-container" ref={swiperRef}>
                            <div className="swiper-wrapper lightgallery">
                              {restaurantContent?.featuredDishes &&
                              restaurantContent.featuredDishes.length > 0 ? (
                                restaurantContent.featuredDishes.map(
                                  (dish, index) => (
                                    <div
                                      key={index}
                                ...
                                <div className="swiper-slide hov_zoom">
                                  ...
                                  >
                                    ...
                                    />
                                    <a
                                      href="/src/assets/images/menu/1.jpg"
                                      className="box-media-zoom popup-image"
                                    >
                                      <i className="fal fa-search"></i>
                                    </a>
                        ...
                        <div className="fw-carousel-button-prev slider-button">
                          <i className="fa-solid fa-caret-left"></i>
                        </div>
                        <div className="fw-carousel-button-next slider-button">
          ...
          <div className="content-section no-padding dark-bg hidden-section">
            ...
            <div className="fw-aminit-wrap">
              {/* Always show restaurant services, use opening hours as additional info if available */}
              {restaurantServices.map((service, index) => (
                <div
                  key={index}
                  className="fw-aminit-item full-height"
                  style={{
              ...
              {/* If we have specific opening hours from admin and more than 3 services, show additional hours */}
              {(restaurantSettings?.openingHours ||
                restaurantContent?.openingHours) &&
                (
                  restaurantSettings?.openingHours ||
                ...
                (
                  ...
                  .map((hours, index) => {
                    ...
                    const [meal, time] = hours
                      .split(':')
                      .map((part) => part.trim());
                    return meal && time ? (
                      <div
                        key={`extra-hours-${actualIndex}`}
                        className="fw-aminit-item full-height"
                        style={{
                          backgroundImage: `url(/src/assets/images/restaurant/1.jpg)`,
                          backgroundSize: 'cover',
                          backgroundPosition: 'center',
                          backgroundRepeat: 'no-repeat',
                        }}
                  ...
                  <div className="hero-menu_header">
                    <ul className="tabs-menu">
                      {MENU_CATEGORIES.map((category) => (
                        <li
                          key={category.id}
                          className={activeTab === category.id ? 'current' : ''}
                        >
                          <a
                            href={`#${category.id}`}
                              ...
                              <div key={index} className="hero-menu-item">
                                ...
                                <div className="hero-menu-item-details">
                                  ...
                                  {item.ingredients && (
                                    ...
                                    >
                                      <i
                                        className="fa-thin fa-mortar-pestle"
