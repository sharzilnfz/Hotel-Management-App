...
const Spa = () => {
    const { spaContent, loading, error, fetchSpaContent } = useContext(ContentContext)
    ...
    const filterServices = () => {
        ...
        if (selectedSpecialist) {
            filtered = filtered.filter(service => 
                service.specialistId === selectedSpecialist
            )
        }
    ...
    const getServiceImageUrl = (service) => {
        if (service?.images && service.images.length > 0 && service.images[0] !== 'placeholder-image.jpg') {
    ...
    const getSpecialistPhoto = (specialistId) => {
        ...
        if (specialist && specialist.photo) {
            return `http://localhost:4000${specialist.photo}`
        }
    ...
    return (
        <>
            ...
            <div className="content-section parallax-section hero-section hidden-section">
                <div className="bg par-elem" data-bg={spaContent?.coverImage ? `http://localhost:4000${spaContent.coverImage}` : `http://localhost:4000/uploads/content/image-1748947475438-981074244.jpeg`}></div>
                <div className="overlay"></div>
                <div className="container">
                    <div className="section-title">
                        <h4>{spaContent?.description || "Relax and rejuvenate your body and mind."}</h4>
            ...
            <div className="content">
                ...
                <div className="breadcrumbs-wrap">
                    <div className="container">
                        <Link to="/">Home</Link><span>{spaContent?.pageTitle || "Spa Services"}</span>
                    </div>
                </div>
                {/* Breadcrumbs end */}
                ...
                <div className="content-section">
                    ...
                    <div className="container">
                                        ...
                                        currentServices.map((service) => (
                                            <div className="spa-service-card" key={service._id}>
                                                <div className="service-card-image">
                                                    <img src={getServiceImageUrl(service)} alt={service.title} />
                                                    <div className="service-badge">
                                                        {service.isPopular && <span className="popular-badge">Popular</span>}
                                                        <span className={`status-badge ${service.displayStatus}`}>
                                                ...
                                                <div className="service-card-content">
                                                    ...
                                                    <h3 className="service-title">
                                                        <Link to={`/spa-service/${service._id}`}>{service.title}</Link>
                                                    </h3>
                                                    ...
                                                    <div className="service-specialist">
                                                        <div className="specialist-info">
                                                            ...
                                                            />
                                                            <div>
                                                                <span className="specialist-name">{service.specialist}</span>
                                                                <span className="specialist-label">Specialist</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="service-details">
                                                        <div className="service-features">
                                                            <div className="feature">
                                                                ...
                                                                <span>{service.durations?.[0]?.duration || 60} min</span>
                                                            </div>
                                                            <div className="feature">
                        ...
                        {/* Pagination */}
                        {!servicesLoading && !error && filteredServices.length > 0 && totalPages > 1 && (
                            ...
                            <div className="booking-form">
                                <div className="form-group">
                                    ...
                                    <div className="duration-options">
                                        {selectedService.durations?.map((duration, index) => (
                                            <div 
                                                key={index}
                                                className={`duration-option ${selectedDuration === duration.duration ? 'selected' : ''}`}
                                                onClick={() => setSelectedDuration(duration.duration)}
                                            >
                                                <div className="duration-time">{duration.duration} min</div>
                                ...
                                {selectedDuration && (
                                    <div className="booking-summary">
                                        ...
                                        <div className="summary-item">
                                            <span>Price:</span>
                                            <span>${selectedService.durations?.find(d => d.duration === selectedDuration)?.price}</span>
                                        </div>
                                        {selectedDate && (
                                            <div className="summary-item">
                                                <span>Date:</span>
