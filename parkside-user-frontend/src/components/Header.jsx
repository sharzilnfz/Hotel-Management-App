                        ...
                        <div className="header-top fl-wrap">
                            <div className="header-top_contacts">
                                {footerContent?.contactInfo ? (
                                    <>
                                        <a href={`tel:${footerContent.contactInfo.phone}`}><span>Call:</span> {footerContent.contactInfo.phone}</a>
                                        <a href="#"><span>Find us:</span> {footerContent.contactInfo.address}</a>
                                    </>
                                ) : (
                                    <>
                                        <a href="#"><span>Call:</span> +489756412322</a>
                                        <a href="#"><span>Find us:</span> USA 27TH Brooklyn NY</a>
                                    </>
                                )}
                            </div>
                            ...
                            <div className="lang-wrap"><a href="#" className="act-lang">En</a><span>/</span><a href="#">Fr</a></div>
                        </div>
                    )}
                    {/* header-top end */}
                    <div className="nav-holder-wrap init-fix-header fl-wrap">
                        <Link to="/" className="logo-holder"><img src={logo} alt="Parkside Hotel" /></Link>
                        {/* navigation */}
                        <div className={`nav-holder main-menu ${isNavOpen ? 'nav-holder-show' : ''}`}>
                            <nav>
                                <ul>
                                    {navigationContent && navigationContent.main ? (
                                        ...
                                        <>
                                            {navigationContent.main
                                                .filter(item => !item.path.includes('/blog') && !item.path.includes('/news') && item.label.toLowerCase() !== 'news' && item.label.toLowerCase() !== 'blog')
                                        ...
                                        <>
                                            <li>
                                                <Link to="/" className="act-link">Home <i className="fas fa-caret-down"></i></Link>
                                                {/* second level */}
                                                <ul>
                                                    <li><Link to="/">Style 1</Link></li>
                                                    <li><Link to="/">Style 2</Link></li>
                                                    <li><Link to="/">Style 3</Link></li>
                                            ...
                                            <li>
                                                <Link to="/rooms">Rooms<i className="fas fa-caret-down"></i></Link>
                                                {/* second level */}
                                                <ul>
                                                    <li><Link to="/rooms">Rooms 1</Link></li>
                                                    <li><Link to="/rooms2">Rooms 2</Link></li>
                                                    <li><Link to="/rooms3">Rooms 3</Link></li>
                                                    <li><Link to="/rooms4">Rooms 4</Link></li>
                                                    <li><Link to="/room-single">Room single</Link></li>
                                                    <li><Link to="/room-single2">Room single 2</Link></li>
                                                    <li><Link to="/room-single3">Room single 3</Link></li>
                                                </ul>
                                                {/* second level end */}
                                            </li>
                        ...
                        <div className="auth-buttons-wrap">
                            <Link to="/login" className="serach-header-btn"><i className="fa-light fa-user"></i> <span>Login</span></Link>
                            <Link to="/signup" className="serach-header-btn signup-btn"><i className="fa-light fa-user-plus"></i> <span>Sign Up</span></Link>
                        </div>
                        {/* nav-button-wrap */}
